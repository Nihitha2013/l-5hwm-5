...
def main():
   ...
   try:
      ...
      print(Fore.GREEN+"Generating caption...")
      caption=get_caption(image)
      print(Fore.GREEN+f"Caption: {caption}")

      more=input("Expenad to 30 words? (y/n): ").strip().lower()
      if more=="y":
         print(Fore.GREEN+"Expanding caption...")
         description=expand_caption(caption)
         print(Fore.GREEN+f"Expanded Caption: {description}")
